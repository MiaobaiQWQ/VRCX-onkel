<template>
    <div class="flex flex-col gap-10 py-2">
        ...
        <SettingsGroup :title="t('view.settings.interface.navigation.header')">
            ...
            <SettingsItem
                :label="t('view.settings.appearance.appearance.show_enhanced_bio')"
                :description="t('view.settings.appearance.appearance.show_enhanced_bio_description')">
                <Switch :model-value="showEnhancedBio" @update:modelValue="setShowEnhancedBio" />
            </SettingsItem>
        </SettingsGroup>
