...
<script setup>
    ...
    import { useGameLogStore, useGameStore } from '../../../stores';
    ...
    const { sessionsCollapseAllTrigger, sessionsExpandAllTrigger, sessionsAllCollapsed } = storeToRefs(gameLogStore);
    ...
    const collapsed = ref(sessionsAllCollapsed.value);

    watch(sessionsCollapseAllTrigger, () => {
        collapsed.value = true;
    });

    watch(sessionsExpandAllTrigger, () => {
        collapsed.value = false;
    });

    watch(sessionsAllCollapsed, (val) => {
        collapsed.value = val;
    });
