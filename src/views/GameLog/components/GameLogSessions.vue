        ...
        <div class="flex shrink-0 items-center gap-2 border-b border-border px-0 pb-4">
            <div class="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto whitespace-nowrap">
                ...
                <div class="flex items-center gap-1 shrink-0">
                    <TooltipWrapper side="bottom" :content="t('view.game_log.sessions.collapse_all')">
                        <Button
                            variant="outline"
                            size="sm"
                            class="h-8 shrink-0 px-2"
                            @click="gameLogStore.setAllSessionsCollapsed(true)">
                            <ChevronsDownUp class="size-4" />
                        </Button>
                    </TooltipWrapper>

                    <TooltipWrapper side="bottom" :content="t('view.game_log.sessions.expand_all')">
                        <Button
                            variant="outline"
                            size="sm"
                            class="h-8 shrink-0 px-2"
                            @click="gameLogStore.setAllSessionsCollapsed(false)">
...
<script setup>
    ...
    import { CalendarRange, ChevronsDownUp, ChevronsUpDown, Star } from 'lucide-vue-next';
