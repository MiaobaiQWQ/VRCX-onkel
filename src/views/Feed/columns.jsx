...
import { useAppearanceSettingsStore, useGalleryStore, useFriendStore } from '../../stores';
        ...
        return (
            <div class="pl-5 text-sm">
                <pre
                    ...
                    innerHTML={
                        appearanceSettingsStore.showEnhancedBio
                            ? formatDifference(original.previousBio, original.bio)
                            : original.bio
                    }
                ></pre>
            </div>
