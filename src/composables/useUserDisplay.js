...
import {
    ...
    userStatusDuration as userStatusDurationPure
...
export function useUserDisplay() {
    ...
    function userStatusDuration(user) {
        return userStatusDurationPure(user);
    }
    ...
    return { userStatusClass, userStatusDuration, userImage, userImageFull };
}
