...
const toolDefinitions = [
    ...
    {
        key: 'vrcx-crash-dumps',
        category: 'shortcuts',
        iconKey: 'folder-x',
        navIcon: 'ri-folder-warning-line',
        titleKey: 'view.tools.shortcuts.vrcx_crash_dumps',
        descriptionKey: 'view.tools.shortcuts.vrcx_crash_dumps_description',
        navEligible: true,
        action: {
            type: 'app-api',
            method: 'OpenVrcxCrashDumps',
            successMessageKey: 'message.file.folder_opened',
            errorMessageKey: 'message.file.folder_missing'
        }
    },
    {
        ...
        category: 'shortcuts',
        iconKey: 'folder-open',
        navIcon: 'ri-folder-shared-line',
        titleKey: 'view.tools.shortcuts.moss',
        descriptionKey: 'view.tools.shortcuts.moss_description',
        navEligible: true,
        action: {
            type: 'app-api',
            method: 'OpenMossFolder',
            successMessageKey: 'message.file.folder_opened',
            errorMessageKey: 'message.file.folder_missing'
        }
    },
    {
        key: 'vrcx-instance2-data',
        category: 'shortcuts',
        iconKey: 'folder-cog',
        navIcon: 'ri-folder-settings-line',
        titleKey: 'view.tools.shortcuts.instance2',
        descriptionKey: 'view.tools.shortcuts.instance2_description',
        navEligible: true,
        action: {
            type: 'app-api',
            method: 'OpenInstance2AppDataFolder',
            successMessageKey: 'message.file.folder_opened',
            errorMessageKey: 'message.file.folder_missing'
        }
    },
    ...
    {
        key: 'export-avatars-list',
        category: 'user',
        iconKey: 'users',
        navIcon: 'ri-file-list-3-line',
        titleKey: 'view.tools.export.export_avatars_list',
        descriptionKey: 'view.tools.user.export_avatars_list_description',
        navEligible: true,
    ...
    },
    {
        ...
        category: 'other',
        iconKey: 'share-line',
        navIcon: 'ri-share-line',
        titleKey: 'view.tools.other.mutual_friends',
        descriptionKey: 'view.tools.other.mutual_friends_description',
        navEligible: true,
        action: { type: 'route', routeName: 'charts-mutual' }
    },
    {
        key: 'tracked-non-friends',
        category: 'other',
        iconKey: 'user-search',
        navIcon: 'ri-user-search-line',
        titleKey: 'side_panel.tracked_nonfriends.tab_label',
        descriptionKey: 'view.tools.other.tracked_nonfriends_description',
        navEligible: true,
        action: { type: 'route', routeName: 'tracked-non-friends' }
    }
];
