...
const navDefinitions = [
    ...
    },
    {
        ...
        tooltip: 'side_panel.tracked_nonfriends.tab_label',
        labelKey: 'side_panel.tracked_nonfriends.tab_label',
        routeName: 'tracked-non-friends'
    },
    {
        key: 'moderation',
    ...
    {
        key: 'charts-two-person-relationship',
        icon: 'ri-user-shared-line',
        tooltip: 'view.tools.other.two_person_relationship',
        labelKey: 'view.tools.other.two_person_relationship',
        routeName: 'charts-two-person-relationship'
    },
    {
        key: 'charts-timeline',
        icon: 'ri-time-line',
