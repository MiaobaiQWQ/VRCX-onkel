...
export const useAppearanceSettingsStore = defineStore(
    ...
    () => {
        ...
        const showEnhancedBio = ref(true);
        ...
        async function initAppearanceSettings() {
            ...
            const [
                ...
                configRepository.getBool('VRCX_showEnhancedBio', true),
                configRepository.getString(
                    'VRCX_fontFamily',
                    APP_FONT_DEFAULT_KEY
                ),
            ...
            showEnhancedBio.value = showEnhancedBioConfig;
         ...
         *
         */
        function setShowEnhancedBio() {
            showEnhancedBio.value = !showEnhancedBio.value;
            configRepository.setBool(
                'VRCX_showEnhancedBio',
                showEnhancedBio.value
            );
        }
