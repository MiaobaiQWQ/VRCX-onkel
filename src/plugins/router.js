...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'social/tracked-non-friends',
                name: 'tracked-non-friends',
                component: () =>
                    import('./../views/Social/TrackedNonFriends.vue')
            },
            {
                path: 'charts',
                name: 'charts',
            ...
            {
                path: 'charts/two-person-relationship',
                name: 'charts-two-person-relationship',
                component: () =>
