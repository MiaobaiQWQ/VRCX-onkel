<template>
    <div class="w-223 flex-1 min-h-0 flex flex-col overflow-y-auto scrollbar-hidden">
...
<script setup>
    ...
    import GroupDialogRolesTab from './GroupDialogRolesTab.vue';
    ...
    const groupDialogTabs = computed(() => [
        ...
        { value: 'Roles', label: t('dialog.group.info.roles') },
        { value: 'Events', label: t('dialog.group.info.upcoming_events') },
