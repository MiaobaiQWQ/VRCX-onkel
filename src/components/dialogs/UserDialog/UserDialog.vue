<template>
    <div class="w-223 flex-1 min-h-0 flex flex-col">
        ...
        <TabsUnderline
            ...
            <template #Info>
                <UserDialogInfoTab ref="infoTabRef" @show-bio-dialog="showBioDialog" @show-bio-history-dialog="showBioHistoryDialog" />
            </template>
        ...
        <BioHistoryDialog :bio-history-dialog="bioHistoryDialog" :user-dialog="userDialog" />
...
<script setup>
    ...
    function showBioHistoryDialog() {
        bioHistoryDialog.value.visible = true;
    }
