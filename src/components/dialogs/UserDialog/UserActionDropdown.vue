            ...
            <DropdownMenuContent>
                ...
                <template v-else>
                    ...
                    <DropdownMenuItem
                        ...
                        @click="onCommand('Toggle Tracking')">
                        <Crosshair class="size-4" />
                        {{
                            isTracked(userDialog.id)
                                ? t('dialog.user.actions.tracked_nonfriend_remove')
                                : t('dialog.user.actions.tracked_nonfriend_add')
                        }}
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem @click="onCommand('Show Avatar Author')">
...
<script setup>
    ...
    import { useGameStore, useLocationStore, useUserStore, useTrackedNonFriendsStore } from '../../../stores';
    ...
    const { isTracked } = useTrackedNonFriendsStore();
